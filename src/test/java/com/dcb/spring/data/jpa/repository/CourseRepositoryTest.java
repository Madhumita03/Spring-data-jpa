...
class CourseRepositoryTest {
    ...
    public void findAllPagination(){
        Pageable firstPagewithThreeRecords =
                PageRequest.of(0, 3); //(starting page no, no. of records per page)
        ...
        long totalPages =
                courseRepository.findAll(secondPageWithTwoRecords)
                        .getTotalPages();      //each page will have 2 records starting from 2nd page
    ...
    public void printFindByTitleContaining(){
        ...
        List<Course> courses = courseRepository.findByTitleContaining("va", firstPageTenRecords).getContent();
        System.out.println("courses = " + courses);
    }
